...
/**
 * URL format (built by YAG):
 * https://whisper-clewdo-api.vercel.app/clewdo/tributes?data=<urlencoded JSON>
 *
 * data is a JSON array of objects like:
 * [{ "n":"DisplayName", "u":"https://cdn.discordapp.com/avatars/...png?size=256" }, ...]
 *
 * Keep keys short to keep the URL short:
 * n = name
 * u = avatar url
 */
...
export default function TributesPage({ searchParams }) {
  ...
  const tributes = (() => {
    if (!dataParam) return [];
    // Next.js gives searchParams already decoded, but some clients double-encode.
    const decoded = typeof dataParam === "string" ? dataParam : "";
